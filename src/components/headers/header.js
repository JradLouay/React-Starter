...
//   <div class="mx-auto px-6 sm:px-6 bg-blue-50">
...
const Header1 = () => {
  ...
  const toggleSolutions = () => setToggleSolution(!toggleSolution);
    ...
    <div class="relative bg-white">
      <div class="mx-auto px-6 sm:px-6">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <nav class="hidden md:flex space-x-10">
            <div class="relative">
              ...
              <button
                ...
                type="button"
                class={`group bg-white rounded-md ${toggleSolution
                    ? "text-gray-900"
                    : "text-gray-500"} inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none`}
              >
                <span>Solutions</span>
                {/* <!--
          ...
          --> */}
              <div
                class={`absolute z-10 -ml-4 mt-3 transform transition ease-out duration-200 ${
                  toggleSolution
